<?php
        ...
        $mcFileManagerConfig['filesystem.path'] = '../../../../../images/site/'; // absolute or relative from this script path.
        $mcFileManagerConfig['filesystem.rootpath'] = '../../../../../images/site/'; // absolute or relative from this script path.
